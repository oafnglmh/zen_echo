...
class _$UpdatingImpl implements _Updating {
  const _$UpdatingImpl(this.profile);
...
abstract class _Updating implements ProfileState {
  const factory _Updating(final Profile profile) = _$UpdatingImpl;
...
abstract class _UpdateSuccess implements ProfileState {
  const factory _UpdateSuccess(final Profile profile) = _$UpdateSuccessImpl;
