...
mixin _$HomeState {
  ...
  TResult when<TResult extends Object?>({
    ...
    required TResult Function(List<MemoryEntity> memories) loaded,
  ...
  TResult? whenOrNull<TResult extends Object?>({
    ...
    TResult? Function(List<MemoryEntity> memories)? loaded,
...
abstract class _$$LoadedImplCopyWith<$Res> {
  ...
  @useResult
  $Res call({List<MemoryEntity> memories});
}
...
class _$LoadedImpl implements _Loaded {
  const _$LoadedImpl({required final List<MemoryEntity> memories})
    : _memories = memories;

  final List<MemoryEntity> _memories;
  @override
  List<MemoryEntity> get memories {
  ...
  @override
  String toString() {
    return 'HomeState.loaded(memories: $memories)';
  }
...
abstract class _Loaded implements HomeState {
  const factory _Loaded({required final List<MemoryEntity> memories}) =
      _$LoadedImpl;
